...
public class dbManager extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {                                           //sql query to insert data in sqllite
        String query = "create table tbl_reminder(id integer primary key autoincrement,title text, duedate text, date text,time text)";
    ...
    public String addreminder(String title, String duedate ,String date, String time) {
