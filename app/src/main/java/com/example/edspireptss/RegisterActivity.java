...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(RegisterActivity.this, com.example.edspireptss.LoginActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void storeUserOnFireBase(String userName,String Enrollment,String email,String phone,String passwd,String UID,String dept){
        ...
        userMap.put("Matric Number",Enrollment);
        userMap.put("Department",dept);
        userMap.put("Email ID",email);
        userMap.put("Phone Number",phone);
        userMap.put("Alumni","none");
        userMap.put("Description","Student of Politeknik Tuanku Syed Sirajuddin.");
...

    {
        if(TextUtils.isEmpty(enroll)){
            enrollment.setError("Please enter Matric Number.");
            ...
            password.setError("Password must have uppercase");
            password.requestFocus();
            return;
        }
        else if(!pswd.matches(".*\\d.*")){
            password.setError("Password must contain numbers");
            password.requestFocus();
            return;
        }
        else if(!pswd.matches(".*[!@#$%^&*+=?-].*")){
            password.setError("Password must contain special characters");
            password.requestFocus();
            return;
        }
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful())
                        {
                            ...
                            Intent intent=new Intent(RegisterActivity.this, com.example.edspireptss.LoginActivity.class);
