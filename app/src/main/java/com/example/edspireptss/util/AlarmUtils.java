package com.example.edspireptss.util;

import static com.example.edspireptss.data.DatabaseHelper.COL_FRI;
import static com.example.edspireptss.data.DatabaseHelper.COL_IS_ENABLED;
import static com.example.edspireptss.data.DatabaseHelper.COL_LABEL;
import static com.example.edspireptss.data.DatabaseHelper.COL_MON;
import static com.example.edspireptss.data.DatabaseHelper.COL_SAT;
import static com.example.edspireptss.data.DatabaseHelper.COL_SUN;
import static com.example.edspireptss.data.DatabaseHelper.COL_THURS;
import static com.example.edspireptss.data.DatabaseHelper.COL_TIME;
import static com.example.edspireptss.data.DatabaseHelper.COL_TUES;
import static com.example.edspireptss.data.DatabaseHelper.COL_WED;
import static com.example.edspireptss.data.DatabaseHelper._ID;
